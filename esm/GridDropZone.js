...
export function GridDropZone(_a) {
    var _b;
    var id = _a.id, boxesPerRow = _a.boxesPerRow, children = _a.children, style = _a.style, _c = _a.disableDrag, disableDrag = _c === void 0 ? false : _c, _d = _a.disableDrop, disableDrop = _d === void 0 ? false : _d, rowHeight = _a.rowHeight, other = __rest(_a, ["id", "boxesPerRow", "children", "style", "disableDrag", "disableDrop", "rowHeight"]);
    var _e = React.useContext(GridContext), traverse = _e.traverse, startTraverse = _e.startTraverse, endTraverse = _e.endTraverse, register = _e.register, measureAll = _e.measureAll, onChange = _e.onChange, remove = _e.remove, getActiveDropId = _e.getActiveDropId;
    var ref = React.useRef(null);
    var _f = useMeasure(ref), bounds = _f.bounds, remeasure = _f.remeasure;
    var _g = __read(React.useState(null), 2), draggingIndex = _g[0], setDraggingIndex = _g[1];
    var _h = __read(React.useState(null), 2), placeholder = _h[0], setPlaceholder = _h[1];
    ...
    var itemsIndexes = (_b = React.Children.map(children, function (_, i) { return i; })) !== null && _b !== void 0 ? _b : [];
